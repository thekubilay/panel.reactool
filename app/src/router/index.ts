...
//   const {user, salons, projects} = useStore()
//   const {get} = APIexecutor()
//   if (to.name === "Entry") return {name: "Dashboard", params:{cid: user.value?.company}}
//   else if (to.params.dynid !== from.params.dynid) {
//     if (to.params.dynid !== from.params.dynid) {
//       isDynidExists(to.params.dynid as string, salons.value, projects.value, get as Function)
//         .then(() => {
//         })
//     }
//   }
