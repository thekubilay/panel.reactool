<template>
  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 496 496" xml:space="preserve">
<path style="fill:#0EE0B8;" d="M404,0H92C78.4,0,64,12.8,64,26.4v320L222.4,496H404c13.6,0,28-12.8,28-26.4V26.4  C432,12.8,417.6,0,404,0z"/>
	...
	<path style="fill:#0667B7;" d="M332.8,168l5.6-5.6c4.8-4.8,4.8-12,0-16c-4.8-4.8-12-4.8-16,0l-5.6,5.6L332.8,168z"/>
      ...
      <rect x="179.048" y="212.557" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -82.161 249.9594)" style="fill:#0667B7;" width="163.198" height="23.2"/>
	...
	<path style="fill:#FFFFFF;" d="M320.8,156l5.6-5.6c4.8-4.8,4.8-12,0-16s-12-4.8-16,0l-5.6,5.6L320.8,156z"/>
      ...
      <rect x="166.658" y="200.381" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -77.1801 237.6323)" style="fill:#FFFFFF;" width="163.198" height="23.2"/>
