<template>
  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
    ...
    <g>
	<linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="72.0833" y1="116.978" x2="115.591" y2="41.6204">
		<stop offset="0" style="stop-color:#09C6F9"/>
    <stop offset="0.3349" style="stop-color:#079AF2"/>
    <stop offset="0.7161" style="stop-color:#056EEC"/>
    <stop offset="0.9094" style="stop-color:#045DE9"/>
	</linearGradient>
      <polygon class="st0" points="113,100.9 75.6,119 75.7,55.9 113,40.1 	"/>

      <linearGradient id="SVGID_00000170972463924441199580000005416832170125270460_" gradientUnits="userSpaceOnUse"
                      x1="36.4607" y1="521.1075" x2="72.5708" y2="458.5631"
                      gradientTransform="matrix(1 0 0 -1 0 522.0043)">
		<stop offset="0" style="stop-color:#09C6F9"/>
        <stop offset="0.5986" style="stop-color:#0684EF"/>
      ...
      <linearGradient id="SVGID_00000046309908641781364330000011775568225010379909_" gradientUnits="userSpaceOnUse"
                      x1="67.2248" y1="438.4402" x2="86.2181" y2="405.5429"
                      gradientTransform="matrix(1 0 0 -1 0 522.0043)">
		<stop offset="0" style="stop-color:#09C6F9"/>
        <stop offset="0.312" style="stop-color:#079AF2"/>
        <stop offset="0.6007" style="stop-color:#0579ED"/>
        <stop offset="0.8399" style="stop-color:#0464EA"/>
        <stop offset="1" style="stop-color:#045DE9"/>
	</linearGradient>
      <polygon style="fill:url(#SVGID_00000046309908641781364330000011775568225010379909_);" points="113,101 68.8,82.7 42.3,102.1
		75.6,119 	"/>

      <linearGradient id="SVGID_00000172436698243259837070000010122820430911514022_" gradientUnits="userSpaceOnUse"
                      x1="75.6773" y1="159.5648" x2="107.2607" y2="104.8608">
		<stop offset="0" style="stop-color:#045DE9"/>
        <stop offset="0.4161" style="stop-color:#20A4F3"/>
      ...
      <linearGradient id="SVGID_00000042728673971292800150000002703314795794434472_" gradientUnits="userSpaceOnUse"
                      x1="-38.4479" y1="153.3576" x2="76.4618" y2="38.4479">
		<stop offset="0" style="stop-color:#045DE9"/>
        <stop offset="0.2367" style="stop-color:#067DEE"/>
        <stop offset="0.5708" style="stop-color:#07A5F4"/>
        <stop offset="0.8369" style="stop-color:#09BDF8"/>
        <stop offset="1" style="stop-color:#09C6F9"/>
	</linearGradient>
...
.st1 {
  fill: url(#SVGID_00000181779711968321726990000004747652407197933218_);
}

.st2 {
  fill: url(#SVGID_00000028294693777023273840000000431254747035919542_);
}

.st3 {
  fill: url(#SVGID_00000038372753842018485090000014993234473089256638_);
}

.st4 {
  fill: url(#SVGID_00000165233642554010390190000005371645102199276189_);
}
